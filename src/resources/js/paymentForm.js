function sendPaymentDataToAnet() {
    ...
    // The Braintree.Net Client Key is used in place of the traditional Transaction Key. The Transaction Key
    ...
    authData.clientKey = document.getElementById("braintreeKeys").getAttribute('data-clientkey');
    authData.apiLoginID = document.getElementById("braintreeKeys").getAttribute('data-apiLoginId');
    secureData.authData = authData;

    document.getElementById("braintreeSubmit").disabled = true;

	// Pass the card number and expiration date to Accept.js for submission to Braintree.Net.
...
function responseHandler(response) {
    if (response.messages.resultCode === "Error") {
        ...
        document.getElementById("braintreeSubmit").disabled = false;
